...
$access = get_accessibility(17,$_SESSION['access']);
...
$document_type	    = db_query('id,descr','cms_master_list',"category_id = 37");

$document_status	= db_query('id,descr','cms_master_list',"category_id = 36");
...
<div id="page-content">
    <div id='wrap'>
        <div id="page-heading">
            <h2><i class="fa fa-upload"></i> Document Archiving</h2>
            <div class="options">
                    ...
                    <div class="panel panel-grape">
                        ...
                        <div class="panel-body" style="display: none">
                            <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label for="dd_type_search" class="col-sm-2 control-label">Type</label>
                                    <div class="col-sm-4">
                                        <select id="dd_type_search" style="width:100%" class="populate">
                                            <option value="">Please Select</option>
                                            <?php
                                            for($i = 0; $i < count($document_type); $i++)
                                            {
                                                ?>
                                                <option value="<?php echo($document_type[$i]['id']) ?>"><?php echo($document_type[$i]['descr']) ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                    ...
                                    <div class="col-sm-4">
                                        <select id="dd_status_search" style="width:100%" class="populate">
                                            <option value="">Please Select</option>
                                            <?php
                                            for($i = 0; $i < count($document_status); $i++)
                                            {
                                                ?>
                                                <option value="<?php echo($document_status[$i]['id']) ?>"><?php echo($document_status[$i]['descr']) ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                    ...
                                    <div class="btn-toolbar">
                                        <div class="btn-group hidden-xs">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="#" onclick="exportTable2CSV('Document Archiving','tbl_list')">Excel File (*.xlsx)</a></li>
                                                <li><a href="#" onclick="exportTable2PDF('Document Archiving','tbl_list','p')">PDF File (*.pdf)</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row" id="new_div" style="display: none">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h4 id="h4_primary_no">Document Number : -</h4>
                            <div class="options">
                                ...
                                <div class="tab-container tab-grape">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div id="tab-one" class="tab-pane active">
                                            ...
                                            <div class="form-group">
                                                <label for="document_date" class="col-sm-2 control-label">Date</label>
                                                <div class="col-sm-4">
                                                    <div class="input-group date">
                                                        <input type="text" id="document_date" class="form-control" data-date-format="dd-mm-yyyy" data-format="dd-mm-yyyy" placeholder="e.g dd-mm-yyyy" required="required">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="input-group date">
                                                        <input type="text" id="from_date" class="form-control" data-date-format="dd-mm-yyyy" data-format="dd-mm-yyyy" placeholder="e.g dd-mm-yyyy" required="required">
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-calendar"></i>
                                                        </span>
                                                    </div>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="input-group date">
                                                        <input type="text" id="to_date" class="form-control" data-date-format="dd-mm-yyyy" data-format="dd-mm-yyyy" placeholder="e.g dd-mm-yyyy" required="required">
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-calendar"></i>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                <label for="dd_doc_type" class="col-sm-2 control-label">Type</label>
                                                <div class="col-sm-4">
                                                    <select id="dd_doc_type" style="width:100%" class="populate" required="required">
                                                        <option value="">Please Select</option>
                                                        <?php
                                                        for($i = 0; $i < count($document_type); $i++)
                                                        {
                                                ...
                                                <label for="dd_notify" class="col-sm-2 control-label">Notification</label>
                                                <div class="col-sm-4">
                                                    <select id="dd_notify" style="width:100%" class="populate" required="required">
                                                        <option value="">Please Select</option>
                                            ...
                                            <div class="form-group">
                                                <label for="notify_date" class="col-sm-2 control-label">Notify Date</label>
                                                <div class="col-sm-4">
                                                    <div class="input-group date">
                                                        <input type="text" id="notify_date" class="form-control" data-date-format="dd-mm-yyyy" data-format="dd-mm-yyyy" placeholder="e.g dd-mm-yyyy" required="required">
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-calendar"></i>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                <label for="dd_client" class="col-sm-2 control-label">Notify Email</label>
                                                <div class="col-sm-4 error-container">
                                                    <select id="dd_notify_email" class="populate" multiple="multiple" required="required">
                                                        <?php
        ...
        <div class="modal-content">
            <form class="form-horizontal" data-validate="parsley" id="remark_form">
                ...
                <div class="modal-body">
                    <input type="hidden" name="document_archive" id="document_archive">
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <textarea name="doc_remark" id="doc_remark" class="form-control marginBottom10px" required="required"></textarea>
                            </div>
                        </div>
